...
public class PrimeiraLinha implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        glWindow.addGLEventListener(new PrimeiraLinha());
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glDrawArrays(GL4.GL_LINES, 0, numVertices);
